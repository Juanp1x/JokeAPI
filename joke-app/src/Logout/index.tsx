    ...
    <>
      <style>{`
        ...
        .auth-title {
          ...
          color: #f8fafc; margin: 0 0 10px; line-height: 1.2; letter-spacing: -0.02em;
        }
        .auth-subtitle {
          font-size: 14px; color: rgba(255,255,255,0.4);
          margin: 0 0 12px; font-weight: 300; line-height: 1.6;
        }
        .user-chip {
        ...
        .user-chip::before {
          ...
          border-radius: 50%; box-shadow: 0 0 6px rgba(34,197,94,0.5);
        ...
        .auth-btn-danger:disabled { opacity: 0.6; cursor: not-allowed; }
        .auth-btn-ghost {
        ...
        <div className="auth-card">
          ...
          {!done ? (
            <>
              ...
              <p className="auth-subtitle">¿Seguro que quieres salir?<br />Tu sesión actual se cerrará.</p>
            ...
            <>
              ...
              <p className="auth-subtitle">Sesión cerrada. Redirigiendo al login...</p>
              <div className="btn-group" style={{ marginTop: "24px" }}>
                <Link to="/login" className="auth-btn-green">Ir al login ahora</Link>
              </div>
            </>
          )}
